class ServiceHttp {
   ...
   */
  updateVoyage(id, name, description, prix, fkPays, version, dateDepart, dateRetour, successCallback, errorCallback) {
      $.ajax({
          type: "PUT",
          dataType: "json",
          data: {
   ...
   * @param {Function} errorCallback - callback en cas d'erreur.
   */
  getAllVoyages(successCallback, errorCallback) {
      $.ajax({
          type: "GET",
   ...
   * @param {Function} errorCallback - callback en cas d'erreur.
   */
  getAllPays(successCallback, errorCallback) {
      $.ajax({
          type: "GET",
